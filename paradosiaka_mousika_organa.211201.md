...
**Η λαουτοκιθάρα:** Ονομάζεται έτσι γιατί μοιάζει με κιθάρα αλλά έχει τον αριθμό των χορδών τουλαγούτου όπως και το κούρδισμα του. Δημιουργήθηκε μετά τον
...
Μετά την πνευματική και καλλιτεχνική ανθοφορία του 19ου αιώνα, η Επτανησιακή Σχολή παρακμάζει και χάνει την ιδιομορφία της. Στο διάστημα της αγγλοκρατίας (1809-1864) σημειώνεται σημαντική κοινωνική ανακατάταξη. Η παλιά αριστοκρατία του Libro d&#39;Oro σταδιακά υποχωρεί μπροστά στην ανερχόμενη αστική τάξη. Στην συνέχεια αρχίζει να υπάρχει έντονο ενδιαφέρον για την πρωτεύουσα της Ελλάδως, την Αθήνα με αποτέλεσμα τα Επτάνησα να μην αποτελούν πλέον το «κέντρο του κόσμου» (Λούτζης 2008:231).

**Επτανησιακή Μουσική σχολή**

«Ο όρος Επτανησιακός έχει αποκτήσει με τα χρόνια και με το ανάστημα της συκοφαντίας περί μη ελληνικότητας, κάτι το σχεδόν υποτιμητικό, μια χροιά εσκεμμένης περιθωριοποίησης δια του τοπικισμού. Ας μιλήσουμε λοιπόν εφεξής μόνο για έντεχνη ελληνική μουσική του 19ου αιώνα...» (Γεώργιος Λεωτσάκος).

**Επίλογος**

Η επτανησιακή μουσική δεν πρέπει να θεωρηθεί ότι αποτέλεσε προδρομική διαδικασία που οδήγησε στην ίδρυση Εθνικής Μουσικής σχολής αλλά συνιστά ένα ξεχωριστό τμήμα της διαδρομής της νεότερης ελληνικής μουσικής παράδοσης. (Κώστιος 2019:320).

H Επτανησιακή Μουσική Σχολή ίσως να είναι η «εθνικότερη» της Νεότερης Ελλάδας καθώς στις αρχές του 19ου αιώνα ήρθε σε επαφή με τις σύγχρονες προς αυτή καλλιτεχνικές τεχνοτροπίες. Τις αναδιατύπωσε και τις αποκρυστάλλωσε μέσα από ένα ιδίωμα μοναδικό για την εποχή του. Απευθύνθηκε κυρίως στο λαό της Επτανήσου, σαν Εθνική σχολή, παρουσιάζοντας έργα τέχνης προσιτά και αγαπητά σε αυτόν (Λούτζης 2008:185).

Μέσα από το έργο του Παύλου Καρρέρ και όχι μόνο, αντιλαμβάνεται κανείς ότι η Επτανησιακή Μουσική είναι άρρηκτα συνδεδεμένη με την λαϊκή παράδοση του ευρύτερου ελλαδικού χώρου αφού χρησιμοποιεί τα ίδια στοιχεία όπως για παράδειγμα τα δημοτικά τραγούδια αλλά και τα όργανα των λαϊκών οργανοπαικτών. Διαφοροποιείται σαφώς προσπαθώντας να πλησιάσει την δυτική μουσική κουλτούρα και να θεωρητικοποιήσει τη μουσική γνώση μέσω των ωδείων, άρα της σπουδής της μουσικής. Μέσω του Καρρέρ διαπιστώνει κανείς την ανάγκη αυτή της αναβάθμισης της ελληνικής μουσικής καθιστώντας την διεθνή αλλά πάντα ελληνική κατ΄ ουσίαν και αίσθημα.
<br><div align="center"><img src="/images/koydounia.jpg" alt="Κουδούνια" style="height: 200px; width:300px;"/>Χυτά Κουδούνια
<br><img src="/images/laterna_defi.jpg" alt="Λατέρνα Ντέφι" style="height: 450px; width:300px;"/><br> Λατέρνα και Ντέφι
<br><img src="/images/kithara.jpg" alt="Κιθαρα" style="height: 300px; width:200px;"/><br>Κιθάρα. Κατασκευή Φώτης Αυγέρης, Αθήνα, εποχή μεσοπολέμου.
<br><img src="/images/violi.jpg" alt="Βιολί" style="height: 300px; width:200px;"/><br>Βιολί και δοξάρι.  Κατασκευή Φώτης Αυγέρης, Αθήνα, εποχή μεσοπολέμου.
<br><img src="/images/madolino_madola.jpg" alt="Μαντολίνο Μάντολα" style="height: 400px; width:300px;"/> Κάτω: Μαντολίνο. Επάνω: Μαντόλα. Κατασκευή Ιωάννης Γ. Γομπάκης,  Αθήνα, εποχή μεσοπολέμου. 
<br><img src="/images/mikrografies.jpg" alt="Μικρογραφίες" style="height: 200px; width:300px;"/>.
<img src="/images/mikrografies2.jpg" alt="Μικρογραφίες" style="height: 200px; width:300px;"/> Λαγούτο. Μικρογραφίες 18ου αι. Χφ. Ερωτόκριτου (1710). Harley 5644, Βρετανικό Μουσείο, Λονδίνο.
</div>
**Βιβλιογραφία**

Ανωγειανάκης, Φ. _Ελληνικά Λαϊκά Μουσικά Όργανα ._ Αθήνα, «Μέλισσα», 1991.

Χαλικιόπουλος Μάντζαρος, Ν., _Δίφωνο, τεύχος 3,_1995.

Ξεπαπαδάκου, A., Καρρέρ_,_Π., _«__Fagotto»_, 2013.

Λούτζης, Ν., _«Η Ζάκυνθος μετά μουσικής» Κοσμική Μουσική (Έντεχνη) Τόμος Β&#39;,_ 2008.

Λούτζης, Ν., _«Η Ζάκυνθος μετά μουσικής» Εκκλησιαστική και Κοσμική Μουσική (Λαϊκή) Τόμος Γ&#39;_, 2010.

Κώστιος Α_. «Επτανησιακή Μουσική, η αναψηλάφιση μιας δικαστικής πλάνης», Ελληνικές μουσικολογικές εκδόσεις 20,_ 2019.

Λεωτσάκος, Γ., _«Λύχνος υπο το μόδιον»_ ένθετο ομώνυμου CD, Πανεπιστημιακές Εκδόσεις Κρήτης

Herzog W., _«The Cave of forgotten Dreams»,_ Documentary, U.K, 2010.
...
Λαμβάνοντας υπόψη την σύνδεση της Ελληνικής λαϊκής μουσικής παράδοσης με την Επτανησιακή μουσική παράδοση που επιχειρήθηκε στην παραπάνω εργασία, προτείνεται ένα εικαστικό διαδραστικό έργο βασισμένο στην προσπάθεια σύνδεσης Ελλάδας – Δύσης, Λαϊκού μουσικού στοιχείου – Έντεχνου μουσικού στοιχείου.

**Τίτλος : ΕCHO-Roots**

Περιγραφή: Έργο Εγκατάσταση με παρουσίαση «Performance».

Μουσική υπόκρουση από ηχητική εγκατάσταση: Παύλος Καρρέρ, «Γερό – Δήμος» από την όπερα _Μάρκος Βότζαρης_  (1858-1860).

Εγκατάσταση σε εσωτερικό χώρο. Μουσικά όργανα και ηχητικά αντικείμενα επάνω σε ξύλινη βάση / τραπέζι που βρίσκεται στο κέντρο του χώρου. Βιολί, κουδούνια, ντέφι, ¨λαλίτσες¨, φλογέρα είναι κάποια από τα μουσικά όργανα/αντικείμενα.

Στον χώρο βρίσκεται καλλιτέχνης η οποία περπατάει ξυπόλητη στο χώρο, αγγίζοντας, αγκαλιάζοντας και χρησιμοποιώντας τα όργανα και τα ηχητικά αντικείμενα αρχικά κατά την κρίση της και συνταιριάζοντάς τα με το νοηματικό υπόβαθρο της μουσικής που ακούγεται. (Διάρκεια 15 λεπτά)

Το κοινό (ένα άτομο τη φορά), καλείται σε δεύτερο χρόνο να χρησιμοποιήσει και αυτό τα μουσικά όργανα / ηχητικά αντικείμενα ή να τα υποδείξει στην καλλιτέχνη να τα χρησιμοποιήσει. (Διάρκεια 15 λεπτά)

Τέλος η performer καλεί να εισέλθουν στον χώρο και να χρησιμοποιήσουν τα μουσικά αντικείμενα όσοι επιθυμούν. Εν συνεχεία, με κραυγές, καλέσματα, και ήχους τους προτρέπει να χρησιμοποιήσουν όχι μόνο τα μουσικά όργανα και τα ηχητικά αντικείμενα, αλλά τα χέρια και τα πόδια τους χτυπώντας τα και παράγοντας ήχους, σφυρίγματα, οδηγώντας το κοινό στη δημιουργία θρήνου – θορύβου δημιουργώντας ένα αποτέλεσμα που ξεφεύγει πια από τον αρχικό εννοιολογικό σύνδεσμο λαϊκής – δυτικής μουσικής και καταλήγοντας σε ένα σύγχρονο διαδραστικό ηχητικό τοπίο. (Διάρκεια 15 λεπτά ή και παραπάνω)
